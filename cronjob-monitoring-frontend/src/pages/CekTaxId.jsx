...
const CekTaxId = () => {
  ...
  const processData = async (data) => {
    try {
      ...
      const response = await axios.get(`${__VITE_REACT_APP_API_URL__}/api/tax-id${finalRoute}`, config);
          ...
          <div className={classes['table-container']}>
            <div className={classes.table}>
              <NewTable columns={[
                ...
                {
                  title: 'Jumlah Tax Dependent',
                  dataIndex: 'jumlah_tax_dependent',
                  key: 'jumlah_tax_dependent',
                  width: '20%',
                },
                {
                  title: 'Change on',
