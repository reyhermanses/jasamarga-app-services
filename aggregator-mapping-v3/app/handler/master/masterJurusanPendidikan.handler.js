const service = require('../../services/master/masterJurusanPendidikan.service')
...
async function create(req, res) {
    try {
        ...
        let insertedData = await service.createData({name, active, "created_by": req.api_key.name})
