const repository = require('../../repositories/master/masterBankKey.repository')
...
async function updateData(id, data, username) {
    let dataUpdate = {}
    if(data.bank_key != null) {
        dataUpdate.bank_key = data.bank_key
    }

    if (data.bank_name != null) {
        dataUpdate.bank_name = data.bank_name
    }
