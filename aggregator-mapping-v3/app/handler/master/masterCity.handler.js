const service = require('../../services/master/masterCity.service')
...
async function create(req, res) {
  try {
    ...
    const { province_id, active, description } = req.body

    let insertedData = await service.createData({ province_id, active, description, "created_by": req.api_key.name })

    if (insertedData == "province tidak ditemukan") {
...
async function update(req, res) {
  ...
  try {
    ...
    if (!data) {
      ...
      if (updatedData == "province tidak ditemukan") {
