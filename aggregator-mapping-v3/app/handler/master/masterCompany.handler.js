const service = require('../../services/master/masterCompany.service')
...
async function create(req, res) {
    try {
        ...
        const {name, kd_comp, nm_singkatan, active} = req.body
        
        let insertedData = await service.createData({name, kd_comp, nm_singkatan, active, "created_by": req.api_key.name})
