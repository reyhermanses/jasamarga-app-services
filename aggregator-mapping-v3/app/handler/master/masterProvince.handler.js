const service = require('../../services/master/masterProvince.service')
...
async function create(req, res) {
  try {
    ...
    const { country_id, active, description } = req.body

    let insertedData = await service.createData({ country_id, active, description, "created_by": req.api_key.name })

    if (insertedData == "country tidak ditemukan") {
...
async function update(req, res) {
  ...
  try {
    ...
    if (!data) {
      ...
      if (updatedData == "country tidak ditemukan") {
