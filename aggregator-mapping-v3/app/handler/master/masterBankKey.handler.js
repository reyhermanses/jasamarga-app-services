const service = require('../../services/master/masterBankKey.service')
...
async function create(req, res) {
    try {
        ...
        const {bank_key, bank_name} = req.body
        
        let insertedData = await service.createData({bank_key, bank_name, "created_by": req.api_key.name})
