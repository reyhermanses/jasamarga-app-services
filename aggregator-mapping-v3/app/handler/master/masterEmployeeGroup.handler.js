const service = require('../../services/master/masterEmployeeGroup.service')
...
async function create(req, res) {
    try {
        ...
        let insertedData = await service.createData({description, active, "created_by": req.api_key.name})
