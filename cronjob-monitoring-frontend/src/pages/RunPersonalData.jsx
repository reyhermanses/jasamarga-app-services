...
const RunPersonalData = () => {
  ...
  const onFinish = (values) => {
    openModal(`Anda Yakin Ingin Menjalankan Cronjob PERSONAL DATA ${values.personnel_number ?? ''} Pada Tanggal ${values.changedate.format('YYYY-MM-DD')} ? Harap Teliti Kembali di Halaman Cek Kiriman Cronjob`, 'warning!', true)
  ...
  const processData = async () => {
    try {
      ...
      const response = await axios.get(`${__VITE_REACT_APP_API_URL__}/cron/run-profile-personal-data${finalRoute}`, config);
...
export default RunPersonalData