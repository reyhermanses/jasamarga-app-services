const service = require('../../services/master/masterReligion.service')
...
async function create(req, res) {
    try {
        ...
        const {religion, active} = req.body
        
        let insertedData = await service.createData({religion, active, "created_by": req.api_key.name})
