const service = require('../../services/master/masterStatusKeluarga.service')
...
async function create(req, res) {
    try {
        ...
        const {description, active, type, convert_families_status, convert_families_object_id} = req.body
        
        let insertedData = await service.createData({description, active, type, convert_families_status, convert_families_object_id, "created_by": req.api_key.name})
